...
export default function Page() {
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-10 max-w-4xl mx-auto space-y-10">
      <PageHeader category="Organisms" title="Top Bar" description="Persistent header with a Test Mode toggle on the left and Ask AI, notifications and account on the right." />
