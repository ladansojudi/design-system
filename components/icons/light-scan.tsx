export function LightScan({ size = 24, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M16 12L8 12" stroke="currentColor" strokeWidth="1.63636" strokeLinecap="round"/>
    </svg>
  );
}
